...
*/
    ...
    function fwds_scripts() {
        ...
        wp_enqueue_script('jquery');
         ...
         wp_register_script( 'slider_core', plugins_url( 'js/jquery.slides.min.js', __FILE__ ),array("jquery") );
        ...
        echo '
            <div class="container">
                <div id="slides">
                    ...
                    <a href="#" class="slidesjs-previous sildesjs-navigation"><i class="icon-chevron-left icon-large"></i></a>
